...
declare class MarginfiAccountWrapper {
    ...
    makeEndFlashLoanIx(override_banks: Map<string, Bank>): Promise<InstructionsWrapper>;
    flashLoan(args: FlashLoanArgs, override_banks: Map<string, Bank>): Promise<string>;
