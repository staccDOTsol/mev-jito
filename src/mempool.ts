...
const PROGRAMS_OF_INTEREST = [
  ...
  new PublicKey("8888882FsxBq7dmc4N1zcMWSKbbsuKgXvfUif2P7S6K6"),
...
async function* mempool(accountsOfInterest: PublicKey[]): AsyncGenerator<MempoolUpdate> {
